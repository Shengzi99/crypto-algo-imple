...
int main()
{
    ...
    uint8_t hash_sm3[32];
    double lapse_sm3;
    TIMING(SM3_256_naive(272, sm3_msg, hash_sm3);, lapse_sm3)
    ...
    // XTS_AES128
    unsigned char pt_xts[32] = {0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44,  0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44};
    unsigned char ct_xts[33]={0};
    unsigned char ct_ref_xts[33]={0xaf, 0x85, 0x33, 0x6b, 0x59, 0x7a, 0xfc, 0x1a, 0x90, 0x0b, 0x2e, 0xb2, 0x1e, 0xc9, 0x49, 0xd2,  0x92, 0xdf, 0x4c, 0x04, 0x7e, 0x0b, 0x21, 0x53, 0x21, 0x86, 0xa5, 0x97, 0x1a, 0x22, 0x7a, 0x89, '\0'};
    ...
    TIMING(XTS_AES128_Encrypt_naive(pt_xts, msg_size, seq_num, key_xts, ct_xts);, lapse_xts_enc);
    TIMING(XTS_AES128_Decrypt_naive(ct_xts, msg_size, seq_num, key_xts, dt_xts);, lapse_xts_dec);
    
    printf("\n[XTS-AES128-naive]: \n");
    printf("timing(ms)(Enc,Dec): %.9lf, %.9lf\n", lapse_xts_enc, lapse_xts_dec);
